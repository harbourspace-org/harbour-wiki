...
export const DEFAULT_DOMAIN_PROMPT = [
  ...
  "BOARD/SLIDE PRIORITY: camera images arrive about every ten seconds and",
  "often repeat most of the same writing. Read only the instructional surface,",
  "ignore people and the room, and merge newly legible definitions, formulas,",
  "code, diagrams, and worked steps into the relevant concept. Never create a",
  "concept merely describing a board/photo, and never duplicate unchanged",
  "writing. If an image is unreadable or occluded, do not guess.",
